...
namespace ACEOMM2
{
    public class Airline : Business
    {
        ...
        public Airline(string _name, string _id, string _countryCode, string _description, string _CEO, string _businessclass, string _type, string imgURL, string _flightPrefix) : base(_name, _id, _countryCode, _description, _CEO, _businessclass, _type, imgURL)
        {
            name = _name;
            // id = _id;
